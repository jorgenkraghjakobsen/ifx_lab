...
"""
WRITTEN BY MARCUS
The class below is to communicate with a socket server with the corresponding functions and parameters as below.
...
class TCPVisaSocket:
    def __init__(self,host,port, s=None, specific_resource=None):
        self.host = host
        self.port = port
        self.prefix = ".#."
    ...
    def list_open_resources(self):
        self.s.send(bytes(f"{self.prefix}list_open_resources",encoding="utf-8"))
        return repr(self.s.recv(4096))
    ...
    def open_resource(
        ...
        **kwargs: Any,
        ...
        if resource_pyclass is None:
            ...
            #print(dir(info.interface_type))
            #print(info.interface_type.name)
        ...
        """
        NOW ITS GONNA CHECK IF THERE IS A SOCKET OPEN AND READY FOR TCP INSTRUMENTS
